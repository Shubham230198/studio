...
export function FlightCard({ flight }: FlightCardProps) {
  ...
  console.log('Icon',getAirlineIcon(flight.airline));
  console.log('Name',getAirlineName(flight.airline));
  ...
  console.log('Airline icon URL:', airlineIcon);
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 min-w-[140px]">
          ...
          <div className="flex flex-col">
            <span className="font-medium text-base text-gray-900">{airlineName}</span>
            <span className="text-sm text-gray-500 font-semibold tracking-wide">{flight.originAirport} - {flight.destinationAirport}</span>
          </div>
        </div>
