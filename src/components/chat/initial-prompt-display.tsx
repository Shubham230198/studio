  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-xl w-full">
        ...
        <Card className="p-4 hover:bg-muted/30 cursor-pointer transition-colors duration-150 rounded-lg shadow-sm border-border/70">
          <CardTitle className="text-md font-medium text-foreground">Suggest travel rewards cards</CardTitle>
          <CardDescription className="text-sm text-muted-foreground mt-1">for frequent international flyers</CardDescription>
        </Card>
        <Card className="p-4 hover:bg-muted/30 cursor-pointer transition-colors duration-150 rounded-lg shadow-sm border-border/70">
